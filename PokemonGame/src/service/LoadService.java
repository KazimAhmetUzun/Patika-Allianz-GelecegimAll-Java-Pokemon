...
public class LoadService {
    ...
    public ArrayList<Pokemon> loadPokemons(){
        ...
        Pokemon pokemon1 = new Pikachu("Pikachu", 100, 150, 25, TypeEnum.ELECTRICY, electricty);
        Pokemon pokemon2 = new Sqiurtle("Squirtle", 110, 140, 20, TypeEnum.WATER, water);
        Pokemon pokemon3 = new Charmander("Charmender", 90, 120, 18, TypeEnum.FIRE, fire);
        Pokemon pokemon4 = new Balbausar("Balbausar", 140, 160, 12, TypeEnum.EARTH, earth);
